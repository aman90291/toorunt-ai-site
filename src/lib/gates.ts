 ...
 * dashboard (`toorunt/dashboard/server.py :: _verification_chain`).
...
export const GATES: Gate[] = [
  { name: "Right repository", evidence: "resolves the target repo from the ticket, using a curated registry or semantic match", actor: "auto" },
  { name: "Requirements understood", evidence: "no material ambiguity. Clarifies with a human before building and never guesses", actor: "auto" },
  ...
  { name: "Rework until shippable", evidence: "when a gate pushes back, it improves the change and runs again. It does not give up", actor: "auto" },
  { name: "Tests green", evidence: "the change's own suite passes; for a bug, a red to green reproduction proves the fix", actor: "auto" },
