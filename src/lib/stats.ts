...
export const RECEIPT = [
  ...
  { value: "$20–150", label: "compute per merged PR", sub: "metered, on the ledger" },
];
...
export const LINES = {
  ...
  sub: "A governed AI engineering team — one bot per teammate, each with its own Jira and GitHub identity, 14 hard gates on every change, and an audit trail you can hand to your auditor.",
};
